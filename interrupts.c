...
static void idt_set_entry(int num, unsigned int base){
    idt[num].offset_low = (unsigned short)(base & 0xFFFF);
    idt[num].selector = 0x08; //kernel code segment
    idt[num].zero = 0; 
    idt[num].flags = 0x8E; //ring 0 32 bit intterupt
...
void interrupts_init(void)
{
    ...
    idt_set_entry(2,  (unsigned int)interrupt_handler_2);
    idt_set_entry(3,  (unsigned int)interrupt_handler_3);
    idt_set_entry(4,  (unsigned int)interrupt_handler_4);
    idt_set_entry(5,  (unsigned int)interrupt_handler_5);
    idt_set_entry(6,  (unsigned int)interrupt_handler_6);
    idt_set_entry(7,  (unsigned int)interrupt_handler_7);
    idt_set_entry(8,  (unsigned int)interrupt_handler_8);
    idt_set_entry(9,  (unsigned int)interrupt_handler_9);
    idt_set_entry(10, (unsigned int)interrupt_handler_10);
    idt_set_entry(11, (unsigned int)interrupt_handler_11);
    idt_set_entry(12, (unsigned int)interrupt_handler_12);
    idt_set_entry(13, (unsigned int)interrupt_handler_13);
    idt_set_entry(14, (unsigned int)interrupt_handler_14);
    idt_set_entry(15, (unsigned int)interrupt_handler_15);
    idt_set_entry(16, (unsigned int)interrupt_handler_16);
    idt_set_entry(17, (unsigned int)interrupt_handler_17);
    idt_set_entry(18, (unsigned int)interrupt_handler_18);
    idt_set_entry(19, (unsigned int)interrupt_handler_19);
    idt_set_entry(20, (unsigned int)interrupt_handler_20);
    idt_set_entry(21, (unsigned int)interrupt_handler_21);
    idt_set_entry(22, (unsigned int)interrupt_handler_22);
    idt_set_entry(23, (unsigned int)interrupt_handler_23);
    idt_set_entry(24, (unsigned int)interrupt_handler_24);
    idt_set_entry(25, (unsigned int)interrupt_handler_25);
    idt_set_entry(26, (unsigned int)interrupt_handler_26);
    idt_set_entry(27, (unsigned int)interrupt_handler_27);
    idt_set_entry(28, (unsigned int)interrupt_handler_28);
    idt_set_entry(29, (unsigned int)interrupt_handler_29);
    idt_set_entry(30, (unsigned int)interrupt_handler_30);
    idt_set_entry(31, (unsigned int)interrupt_handler_31);

    /* 3) IRQs 0–15 (remapped to 0x20–0x2F) */
    idt_set_entry(32, (unsigned int)interrupt_handler_32);
    idt_set_entry(33, (unsigned int)interrupt_handler_33);
    idt_set_entry(34, (unsigned int)interrupt_handler_34);
    idt_set_entry(35, (unsigned int)interrupt_handler_35);
    idt_set_entry(36, (unsigned int)interrupt_handler_36);
    idt_set_entry(37, (unsigned int)interrupt_handler_37);
    idt_set_entry(38, (unsigned int)interrupt_handler_38);
    idt_set_entry(39, (unsigned int)interrupt_handler_39);
    idt_set_entry(40, (unsigned int)interrupt_handler_40);
    idt_set_entry(41, (unsigned int)interrupt_handler_41);
    idt_set_entry(42, (unsigned int)interrupt_handler_42);
    idt_set_entry(43, (unsigned int)interrupt_handler_43);
    idt_set_entry(44, (unsigned int)interrupt_handler_44);
    idt_set_entry(45, (unsigned int)interrupt_handler_45);
    idt_set_entry(46, (unsigned int)interrupt_handler_46);
    idt_set_entry(47, (unsigned int)interrupt_handler_47);
